...
import avatar from "../../assets/images/dashboard-header/avatar.png";

const Header = (props: any) => {
    return (
        <div id="header">
            {/* burger Icon */}
            <svg id="burger-icon" onClick={() => props.handleClick()} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <div className="search">
                ...
                <span><img src={searchIcon} id="search-icon"/></span>
            </div>

            <div className="tabs">
                <Link to="#">Docs</Link>

                <svg id="notifications" width="26" height="26" viewBox="0 0 26 26" fill="#213F7D" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* <img src={notificationIcon} id="notifications" alt="notification Icon" /> */}


                <div id="user"> 
                    <img src={avatar} id="profile" alt="User profile" />
