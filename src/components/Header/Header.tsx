...
const Header = ({ handleClick, }: { handleClick: () => void }) => {
    ...
    return (
        <div id="header">
            ...
            <img src={'/login/lendsqr-logo.svg'} data-testid="logo" id="logo" />
            ...
            <div className="tabs">
                ...
                <svg id="notifications" data-testid="notifications" width="26" height="26" viewBox="0 0 26 26" fill="#213F7D" xmlns="http://www.w3.org/2000/svg">
                ...
                <div id="user"> 
                    <img src={'/dashboard-header/avatar.png'} id="profile" alt="User profile" />
